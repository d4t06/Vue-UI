...
import { AtSymbolIcon, ChevronLeftIcon, ChevronRightIcon } from "@heroicons/vue/16/solid";

const expand = ref(false);

const classes = {
   container:
      "bg-gray-700 text-white transition-[width] max-h-[100vh] relative flex-shrink-0 w-[50px] sm:w-[70px]",
...
<template>
   <div
      :class="`${classes.container} ${expand ? classes.containerExpand : ''}`"
   >
      <div :class="classes.head">Vue UI</div>
      <div>
